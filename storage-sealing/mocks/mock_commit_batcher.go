...
// Source: github.com/filecoin-project/venus-sealer/storage-sealing (interfaces: CommitBatcherApi)
...
import (
	...
	miner0 "github.com/filecoin-project/venus/pkg/specactors/builtin/miner"
...
func (m *MockCommitBatcherApi) ChainBaseFee(arg0 context.Context, arg1 types.TipSetToken) (big.Int, error) {
	m.ctrl.T.Helper()
...
func (m *MockCommitBatcherApi) ChainHead(arg0 context.Context) (types.TipSetToken, abi.ChainEpoch, error) {
	m.ctrl.T.Helper()
...
func (m *MockCommitBatcherApi) MessagerSendMsg(arg0 context.Context, arg1, arg2 address.Address, arg3 abi.MethodNum, arg4, arg5 big.Int, arg6 []byte) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCommitBatcherApiMockRecorder) MessagerSendMsg(arg0, arg1, arg2, arg3, arg4, arg5, arg6 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCommitBatcherApi) StateMinerInitialPledgeCollateral(arg0 context.Context, arg1 address.Address, arg2 miner.SectorPreCommitInfo, arg3 types.TipSetToken) (big.Int, error) {
	m.ctrl.T.Helper()
...
func (m *MockCommitBatcherApi) StateNetworkVersion(arg0 context.Context, arg1 types.TipSetToken) (network.Version, error) {
	m.ctrl.T.Helper()
