...
import (
	...
	types "github.com/filecoin-project/venus-market/types"
	types0 "github.com/filecoin-project/venus-sealer/types"
...
func (m *MockSealingAPI) ChainBaseFee(arg0 context.Context, arg1 types0.TipSetToken) (big.Int, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) ChainGetMessage(arg0 context.Context, arg1 cid.Cid) (*messager.Message, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) ChainHead(arg0 context.Context) (types0.TipSetToken, abi.ChainEpoch, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChainHead", arg0)
	ret0, _ := ret[0].(types0.TipSetToken)
...
func (m *MockSealingAPI) GetUnPackedDeals(arg0 context.Context, arg1 address.Address, arg2 *types.GetDealSpec) ([]*types.DealInfoIncludePath, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUnPackedDeals", arg0, arg1, arg2)
	ret0, _ := ret[0].([]*types.DealInfoIncludePath)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSealingAPI) MessagerSearchMsg(arg0 context.Context, arg1 string) (*types0.MsgLookup, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) MessagerWaitMsg(arg0 context.Context, arg1 string) (types0.MsgLookup, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateComputeDataCommitment(arg0 context.Context, arg1 address.Address, arg2 abi.RegisteredSealProof, arg3 []abi.DealID, arg4 types0.TipSetToken) (cid.Cid, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateGetRandomnessFromBeacon(arg0 context.Context, arg1 crypto.DomainSeparationTag, arg2 abi.ChainEpoch, arg3 []byte, arg4 types0.TipSetToken) (abi.Randomness, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateGetRandomnessFromTickets(arg0 context.Context, arg1 crypto.DomainSeparationTag, arg2 abi.ChainEpoch, arg3 []byte, arg4 types0.TipSetToken) (abi.Randomness, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateLookupID(arg0 context.Context, arg1 address.Address, arg2 types0.TipSetToken) (address.Address, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateMarketStorageDeal(arg0 context.Context, arg1 abi.DealID, arg2 types0.TipSetToken) (*types1.MarketDeal, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StateMarketStorageDeal", arg0, arg1, arg2)
	ret0, _ := ret[0].(*types1.MarketDeal)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSealingAPI) StateMinerActiveSectors(arg0 context.Context, arg1 address.Address, arg2 types0.TipSetToken) ([]*miner0.SectorOnChainInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateMinerAvailableBalance(arg0 context.Context, arg1 address.Address, arg2 types0.TipSetToken) (big.Int, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateMinerInfo(arg0 context.Context, arg1 address.Address, arg2 types0.TipSetToken) (miner0.MinerInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateMinerInitialPledgeCollateral(arg0 context.Context, arg1 address.Address, arg2 miner.SectorPreCommitInfo, arg3 types0.TipSetToken) (big.Int, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateMinerPartitions(arg0 context.Context, arg1 address.Address, arg2 uint64, arg3 types0.TipSetToken) ([]types1.Partition, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StateMinerPartitions", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].([]types1.Partition)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSealingAPI) StateMinerPreCommitDepositForPower(arg0 context.Context, arg1 address.Address, arg2 miner.SectorPreCommitInfo, arg3 types0.TipSetToken) (big.Int, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateMinerProvingDeadline(arg0 context.Context, arg1 address.Address, arg2 types0.TipSetToken) (*dline.Info, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateMinerSectorAllocated(arg0 context.Context, arg1 address.Address, arg2 abi.SectorNumber, arg3 types0.TipSetToken) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateMinerSectorSize(arg0 context.Context, arg1 address.Address, arg2 types0.TipSetToken) (abi.SectorSize, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateMinerWorkerAddress(arg0 context.Context, arg1 address.Address, arg2 types0.TipSetToken) (address.Address, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateNetworkVersion(arg0 context.Context, arg1 types0.TipSetToken) (network.Version, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateSearchMsg(arg0 context.Context, arg1 cid.Cid) (*types0.MsgLookup, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateSectorGetInfo(arg0 context.Context, arg1 address.Address, arg2 abi.SectorNumber, arg3 types0.TipSetToken) (*miner0.SectorOnChainInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateSectorPartition(arg0 context.Context, arg1 address.Address, arg2 abi.SectorNumber, arg3 types0.TipSetToken) (*miner0.SectorLocation, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateSectorPreCommitInfo(arg0 context.Context, arg1 address.Address, arg2 abi.SectorNumber, arg3 types0.TipSetToken) (*miner0.SectorPreCommitOnChainInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockSealingAPI) StateWaitMsg(arg0 context.Context, arg1 cid.Cid) (types0.MsgLookup, error) {
	m.ctrl.T.Helper()
