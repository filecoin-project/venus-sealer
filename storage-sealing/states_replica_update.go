...
func (m *Sealing) handleProveReplicaUpdate(ctx statemachine.Context, sector types.SectorInfo) error {
...
func (m *Sealing) handleSubmitReplicaUpdate(ctx statemachine.Context, sector types.SectorInfo) error {
