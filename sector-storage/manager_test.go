...
func TestSnapDeals(t *testing.T) {
	...
	localTasks := []types.TaskType{
		types.TTAddPiece, types.TTPreCommit1, types.TTPreCommit2, types.TTCommit1, types.TTCommit2, types.TTFinalize,
		types.TTFetch, types.TTReplicaUpdate, types.TTProveReplicaUpdate1, types.TTProveReplicaUpdate2, types.TTUnseal,
		types.TTRegenSectorKey,
	}
	wds := datastore.NewMapDatastore()

	w := NewLocalWorker(WorkerConfig{TaskTypes: localTasks}, stor, lstor, idx, m, statestore.NewDsStateStore(wds))
