...
func addTestWorker(t *testing.T, sched *scheduler, index *stores.Index, name string, taskTypes map[types.TaskType]struct{}) {
	w := &schedTestWorker{
		name:      name,
		taskTypes: taskTypes,
...
func TestSched(t *testing.T) {
	...
	t.Run("one-pc1", testFunc([]workerSpec{
		{name: "fred", taskTypes: map[types.TaskType]struct{}{types.TTPreCommit1: {}}},
	}, []task{
	...
	t.Run("pc1-2workers-1", testFunc([]workerSpec{
		{name: "fred2", taskTypes: map[types.TaskType]struct{}{types.TTPreCommit2: {}}},
		{name: "fred1", taskTypes: map[types.TaskType]struct{}{types.TTPreCommit1: {}}},
	}, []task{
	...
	t.Run("pc1-block-pc2", testFunc([]workerSpec{
		{name: "fred", taskTypes: map[types.TaskType]struct{}{types.TTPreCommit1: {}, types.TTPreCommit2: {}}},
	}, []task{
