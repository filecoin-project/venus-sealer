...
type WorkerCalls interface {
	DataCid(ctx context.Context, pieceSize abi.UnpaddedPieceSize, pieceData storage.Data) (types.CallID, error)
...
type WorkerReturn interface {
	ReturnDataCid(ctx context.Context, callID types.CallID, pi abi.PieceInfo, err *CallError) error
